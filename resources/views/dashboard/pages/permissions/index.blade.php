                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                            ...
                                            @if($permission->roles->count() > 0)
                                                <div class="d-flex flex-wrap gap-1">
                                                    ...
                                                    @if($permission->roles->count() > 3)
                                                        <span
                                                            class="badge bg-label-secondary">+{{ $permission->roles->count() - 3 }}</span>
                                                    @endif
                                                </div>
                                            @else
                                                <span class="text-muted">لا توجد أدوار مرتبطة</span>
                                            @endif
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted">لا توجد صلاحيات</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
