...
@section('content')
    <div class="card shadow-sm border-0">
        <div class="card-header border-0 bg-transparent pb-3">
            <h4 class="mb-1">Edit Industry</h4>
            <p class="mb-0 text-muted">Update industry information and options.</p>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form method="POST" action="{{ route('dashboard.industries.update', $industry) }}"
